...
crop_info = {
    "rice": {
        "image": "/Users/siddhisharma/Downloads/cropify_ml/rice.jpeg",
        "facts": {
    ...
    "wheat": {
        "image": "/Users/siddhisharma/Downloads/cropify_ml/wheat.jpeg",
        "facts": {
    ...
    "maize": {
        "image": "/Users/siddhisharma/Downloads/cropify_ml/maize.jpeg",
        "facts": {
    ...
    "bajra": {
        "image": "/Users/siddhisharma/Downloads/cropify_ml/bajra.jpeg",
        "facts": {
...
logo_path = "/Users/siddhisharma/Downloads/cropify_ml/Green and Beige Classic Elegant Nature Foundation Logo (2).png"
...
# -------------------- Load ML Models --------------------
model_paths = {
    "Random Forest": "/Users/siddhisharma/Downloads/cropify_ml/Random_Forest.pkl",
    "MLP": "/Users/siddhisharma/Downloads/cropify_ml/MLP.pkl",
    "Naive Bayes": "/Users/siddhisharma/Downloads/cropify_ml/naive_bayes.pkl",
    "Decision Tree": "/Users/siddhisharma/Downloads/cropify_ml/random_tree.pkl"
}
...
if submitted:
    # Existing success and display code

    # Generate HTML content
    html_content = f"""
    <h1>Crop Prediction Report</h1>
    <p><strong>Predicted Crop:</strong> {prediction.capitalize()}</p>
    <h2>Facts:</h2><p>{fact}</p>
    <h2>Tips:</h2><p>{tip}</p>
    <h2>Suggestions:</h2><p>{suggestion}</p>
    """
# ---------------- Data Analysis Tab ------------------
with tab2:
    st.markdown('<div class="section-card">', unsafe_allow_html=True)
...
with tab3:
    ...
    with col1:
        st.image("/Users/siddhisharma/Downloads/cropify_ml/work diagaram.png", caption="Model Workflow", width=400)

    with col2:
        st.image("/Users/siddhisharma/Downloads/cropify_ml/diagaram of chart.png", caption="Systematic Workflow", width=400)
